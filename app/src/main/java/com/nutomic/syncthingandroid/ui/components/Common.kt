...
fun ToggleRow(
    ...
    Row(
        ...
        // Display-only switch: interaction is owned by the row's toggleable,
        // so the hover/ripple bounds match the full row instead of the
        // switch's own minimum touch target.
